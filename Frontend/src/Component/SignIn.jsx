...
function SignIn() {
  ...
  return (
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-100 via-purple-100 to-blue-100 px-4 py-8">
      {/* CHANGED: w-full on mobile, capped with max-w-md; padding p-6 on mobile, p-10 on sm+ */}
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-6 sm:p-10">
        {/* CHANGED: text-3xl on mobile */}
        ...
        <p className="text-center text-gray-600 mt-6 text-sm sm:text-base">
          ...
          <a href="/signup" className="text-[#C30E59] font-bold hover:underline">Sign Up</a>
        </p>
      </div>
    </div>
  );
